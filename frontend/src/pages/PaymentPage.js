...
const PaymentPage = () => {
  ...
  const { routeId, train, boardingStop, deboardingStop, journeyDate, classType, passengers, totalFare } = location.state || {};
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      const { data } = await bookingAPI.create({
        routeId,
        boardingStopId: boardingStop._id,
        deboardingStopId: deboardingStop._id,
        journeyDate,
        classType,
    ...
    <div className="payment-page container">
      ...
      <div className="payment-summary">
        <div className="summary-card">
          ...
          <p>{boardingStop.station.name} ({boardingStop.station.code}) → {deboardingStop.station.name} ({deboardingStop.station.code})</p>
